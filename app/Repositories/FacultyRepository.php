            ...
            foreach ($request->tab_title as $key => $value) {
                ...
                if (is_array($value)){
                    foreach ($value as $tab_key => $tab_value) {
                        ...
                        FacultyTab::where('id', $key)->update(['tab_title' => $tab_value,'tab_body' => $request->tab_body[$key][$tab_key] ]);
                    }
                }
                else
                {
                    ...
                    $faculty_tab->tab_title = $request->tab_title[$key];
                    $faculty_tab->tab_body = $request->tab_body[$key];
