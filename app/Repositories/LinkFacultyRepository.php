...
class LinkFacultyRepository
{
    ...
    public function store($request)
    {
        //dd($request->all());
            ...
            $record_exists = LinkFaculty::where('post_id',$request->post_id)->where('post_tab_id',$request->post_tab_id)->where('faculty_id',$request->faculty_id)->first();
    ...
    {
            $record_already_exists = LinkFaculty::where('id','!=',$link_faculty->id)->where('faculty_id','=',$request->faculty_id)->where('post_id','=',$request->post_id)->where('post_tab_id','=',$request->post_tab_id)->whereNull('deleted_at')->first();
