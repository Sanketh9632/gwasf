...
<head>
  ...
  <title>@lang('Safety Guard - Administration')</title>
...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
    ...
    <aside class="main-sidebar">
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li><a href="{{ route('gallery.index') }}"><i class="fa fa-file-image-o"></i><span>@lang('Posts Gallery')</span></a></li>
          ...
          {{-- <li><a href="{{ route('prospects.graduation-index') }}"><i class="fa fa-graduation-cap"></i> <span>@lang('Quotation Details')</span></a></li> --}}
    ...
    <footer class="main-footer">
      <!-- Default to the left -->
      <div class="pull-right">
        <strong>Copyright &copy; {{ now()->year }} <a href="{{route('home')}}">@lang('Safety Guard')</a> . </strong> @lang('All rights reserved').
      </div>
    </footer>
