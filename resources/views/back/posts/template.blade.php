...
<div class="row">
    ...
    <div class="col-md-8">
	     ...
	     <div class="row">
              <div class="col-md-4">
                 <div class="form-group">
                    <label for="menus">Class Name</label>
                    <input type="text" class="form-control" name="class_name" id="class_name" value="{{ isset($post) ? $post->class_name : '' }} "/>
                </div>
            </div>
            <div class="col-md-4">
               <div class="form-group">
                <label for="menus">Location</label>
                <input class="form-control" type="text" id="location" name="location" value="{{ isset($post) ? $post->location : '' }}"/>
            </div>
        </div>
            <div class="col-md-4">
                <div class="form-group">
        ...
        <div class="col-md-4">
            <div class="form-group">
                <label for="menus">Course Fee</label>
                <input class="form-control" type="text" id="fee" name="fee" value="{{ isset($post) ? $post->fee : '' }}"/>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-group">
                <label for="menus">Type</label>
                <input class="form-control" type="text" id="type" name="type" value="{{ isset($post) ? $post->type : '' }}"/>
            </div>
        </div>
        <!-- <div class="col-md-4">
            <div class="form-group">
...
@include('back.partials.input', [
    ...
    'input' => [
        'name' => 'header_script',
        'value' => isset($post) ? $post->header_script : '',
        'input' => 'text',
        'title' => __('Header Script'),
        'input' => 'textarea',
        'rows' => 4,
        'required' => false,
    ]
...
<div class="icon">
    ...
    @lang('Home Image')
    @endslot
    <img id="home_images" src="@isset($post) {{ $post->home_image }} @endisset" alt="" class="img-responsive img-fluid">
    @slot('footer')
    <div class="{{ $errors->has('icon') ? 'has-error' : '' }}">
        <div class="input-group">
            <div class="input-group-btn">
                <a href="" class="popup_selector btn btn-primary" data-inputid="home_image">@lang('Select an image')</a>
            </div>
            <!-- /btn-group -->
            <input class="form-control" type="text" id="home_image" name="home_image" value="{{ old('home_image', isset($post) ? $post->home_image : '') }}">
        </div>
                    ...
                    @slot('footer')
                        <div class="{{ $errors->has('tab_image') ? 'has-error' : '' }}">
                            <div class="input-group">
                                ...
                                <!-- /btn-group -->
                                <input class="form-control tab_image" type="text" id="tab_image" name="tab_image[0]" value="@isset($post->tab_image) {{ $post->tab_image }} @endisset">
                            </div>
...
<script>
 ...
 CKEDITOR.replace('body2', {customConfig: 'https://cdn.ckeditor.com/ckeditor5/27.0.0/inline/ckeditor.js'})
 ...
 else if(requestingField == 'home_image')
 {
     $('#home_images').attr('src', '\\' + 'storage/' +filePath)
 }
...
$('#excerpt').attr('maxlength','150');

</script>


<script src="{{ asset('js/post.js') }}?v=1.0"" async></script>
