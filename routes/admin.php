...
//Prospect Downloads
    ...
    Route::get('prospects.graduation-view/{id}', [
	'as' => 'prospects.graduation-view',
	'uses' => 'DownloadController@viewFullRegister'
    ]);

    Route::post('export-graduation', ['as' => 'prospects.graduation-download', 'uses' => 'DownloadController@getExportGraduationReport']);
